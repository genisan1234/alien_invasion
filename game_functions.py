...
def check_events(ai_settings,screen,stats,sb,play_button,ship,aliens,bullets,music):
	"""Respond to keypresses and mouseevents."""
	for event in pygame.event.get():
		if event.type == pygame.QUIT:
			sys.exit()
		elif event.type == pygame.KEYDOWN:
			check_keydown_events(event,ai_settings,screen,ship,bullets,stats,sb,play_button,aliens,music)
...
def check_keydown_events(event,ai_settings,screen,ship,bullets,stats,sb,play_button,aliens,music):
...
def start_game(ai_settings,screen,stats,sb,play_button,ship,aliens,bullets,button_clicked):
...
def check_high_score(stats,sb):
	...
	if stats.score > stats.high_score:
		...
		run.write_high_score(stats.high_score)
		sb.prep_high_score()
